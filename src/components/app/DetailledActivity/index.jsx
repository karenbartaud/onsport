...
function DetailledActivity() {
  ...
  React.useEffect(
    () => {
      window.scrollTo(0, 0);
      axios.get(`http://localhost:3306/api/activity/${activityId}`, {
        headers: {
      ...
      axios.get(`http://localhost:3306/api/comment/activity/${activityId}`, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      }).then(
      ...
      axios.get('http://localhost:3306/api/activity', {
        headers: {
  ...
  React.useEffect(() => {
    axios.get(`http://localhost:3306/api/user/profil/${activityInfo.user_id}`, {
      headers: {
        Authorization: `Bearer ${token}`,
      },
    }).then(
    ...
    <>
      ...
      <div className="activity__content">
        ...
        <div className="activity__author">
          ...
          <img alt="profile" className="photo_profile" width="50" height="50" src={user.photo ? `http://localhost:3306/api/user/profil/${user.id}/photo/${user.photo}` : defaultProfilePicture} />
